...
#   curl -fsSL https://raw.githubusercontent.com/sigmaray/go-blog/main/docs/example-postgresql-docker-compose/scripts/setup-vps.sh | bash
#   # or
...
main() {
  ...
  log "  Example:   postgresql://${POSTGRES_USER}:<password>@postgresql:5432/goblog"
  log "  Next step: deploy apps on network infra with GO_BLOG_DATABASE_* pointing at postgresql:5432"
}
